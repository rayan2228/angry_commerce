...
<head>
    ...
    @vite(['public/frontend_assets/css/woocommerce.css', 'public/frontend_assets/css/nice-select.css', 'public/frontend_assets/css/jquery-ui.css', 'public/frontend_assets/css/magnific-popup.css', 'public/frontend_assets/css/slick-theme.css', 'public/frontend_assets/css/slick.css', 'public/frontend_assets/css/slick.css', 'public/frontend_assets/css/animate.css', 'public/frontend_assets/css/icofont.css', 'public/frontend_assets/css/stroke-gap-icons.css', 'public/frontend_assets/css/fontawesome.css', 'public/frontend_assets/css/bootstrap.min.css', 'public/frontend_assets/css/style.css'])
</head>
                    ...
                    <div class="col col-lg-4 col-md-6 col-sm-6">
                        <div class="footer_widget footer_contact">
                            ...
                            <ul class="store_btns_group ul_li">
                                <li><a href="#!"><img src="{{ asset('frontend_assets') }}/images/app_store.png"
                                            alt="app_store"></a></li>
                                <li><a href="#!"><img src="{{ asset('frontend_assets') }}/images/play_store.png"
                                            alt="play_store"></a></li>
                            </ul>
                        </div>
                    </div>
