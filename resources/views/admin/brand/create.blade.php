                        ...
                        <div class="settings-form">
                            @if (session('brand_add'))
                                <div class="alert alert-success" role="alert">
                                    <h5>{{ session('brand_add') }}</h5>
                                </div>
                            @endif
                            <h4 class="text-primary">Add Brand</h4>
                            <form action="{{ route('admin.brand.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-12">
                                        ...
                                        <input style="color: black; border-color:rgba(128, 128, 128, 0.365);" type="text"
                                            class="form-control" name="brand_name" value="{{ old('brand_name') }}">
                                        @error('brand_name')
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-12">
                                        ...
                                        <input style="color: black; border-color:rgba(128, 128, 128, 0.365);" type="text"
                                            class="form-control" name="brand_slug" value="{{ old('brand_slug') }}">
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="form-group col-md-12">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <div class="mb-3">
                                            <textarea style="color: black; border-color:rgba(128, 128, 128, 0.365);"class="form-control" name="brand_description"
                                                rows="10">{{ old('brand_description') }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <select style="color: black; border-color:rgba(128, 128, 128, 0.365);"
                                            ...
                                            <option value="popular_brand">popular brand</option>
                                        </select>
