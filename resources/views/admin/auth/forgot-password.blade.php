                        ...
                        <div class="auth-form">
                            ...
                            <form action="{{ route('admin.password.email') }}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="email" value="{{ old('email') }}" style="color: black">
                                </div>
                                <div class="text-center">
                                    <button type="submit" class="btn bg-white text-primary btn-block">Password Reset Link</button>
                                </div>
                            </form>
                        </div>
                    </div>
